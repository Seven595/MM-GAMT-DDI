...
# for idx in [1]:
    ...
    for f in feature_sel:  
        ...
        for epoch in range(epochs):
            ...
            if(acc > best_acc):
                ...
                torch.save(maml.state_dict(), "./ckpt/"+"570covcv0123k50adambatch1-"+str(idx)+"featurefusion-"+str(f)+"best.pt") 
                count = 0
            else:
                count+=1
            if count > 100:
                break
            print_file("570covcv0123k50adambatch1 epoch: {}, acc:{}, loss: {}".format(epoch, acc, l), "./result.out")
    ...
    print(cv_all_result)
    save_result(str(idx) + "570target_enz_5_150_768cov0123k50adambatch1_1t_0123_0.001_gat", 'all', "META", cv_all_result)
    save_result(str(idx) + "570target_enz_5_150_768cov0123k50adambatch1_1t_0123_0.001_gat", 'each', "META", cv_each_result)
...
save_result("570target_enz_5_150_768cov0123k50adambatch1_1t_0123_0.001_gat", 'all', "META", all_result)
save_result("570target_enz_5_150_768cov0123k50adambatch1_1t_0123_0.001_gat", 'each', "META", each_result)
