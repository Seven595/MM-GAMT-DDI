...
for idx in range(5):
    ...
    if len(pred_score_feature_best) == 5:
        pred_score_res = ((pred_score_feature_best[0] + pred_score_feature_best[1]*0.8 + pred_score_feature_best[2] + pred_score_feature_best[3]*0.8 + pred_score_feature_best[4]) / 4.6).cpu().numpy()
    ...
    print(cv_all_result)
    save_result(str(idx) + "task3570covgelucv01234k50adambatch1new", 'all', "META", cv_all_result)
    save_result(str(idx) + "task3570covgelucv01234k50adambatch1new", 'each', "META", cv_each_result)
...
save_result("task3570covgelucv01234k50adambatch1new", 'all', "META", all_result)
save_result("task3570covgelucv01234k50adambatch1new", 'each', "META", each_result)
