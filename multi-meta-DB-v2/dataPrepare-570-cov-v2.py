...
for idx in [0, 1, 2, 3, 4]:
    ...
    for f in feature_sel:  
        ...
        for epoch in range(epochs):
            ...
            if(acc > best_acc):
                ...
                torch.save(maml.state_dict(), "./ckpt/"+"570covgelucv0123k50adambatch1-"+str(idx)+"withrealfusion-"+str(f)+"best.pt") 
                count = 0
            else:
                count+=1
            if count > 100:
    ...
    print(cv_all_result)
    save_result(str(idx) + "570target_enz_5_150_768covgeluwithfusion0123k50adambatch1_1t_0123_0.001_gat", 'all', "META", cv_all_result)
    save_result(str(idx) + "570target_enz_5_150_768covgeluwithfusion0123k50adambatch1_1t_0123_0.001_gat", 'each', "META", cv_each_result)
...
save_result("570target_enz_5_150_768covgeluwithfusion0123k50adambatch1_1t_0123_0.001_gat", 'all', "META", all_result)
save_result("570target_enz_5_150_768covgeluwithfusion0123k50adambatch1_1t_0123_0.001_gat", 'each', "META", each_result)
