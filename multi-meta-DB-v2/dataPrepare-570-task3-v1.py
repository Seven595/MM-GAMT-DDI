...
for idx in range(5):
    ...
    for f in feature_sel:  
        maml.load_state_dict(torch.load("./ckpt/"+"570covgelucv0123k50adambatch1-"+str(idx)+"featurefusion-"+str(f)+"best.pt"))
        if f == 0:
    ...
    print(cv_all_result)
    save_result(str(idx) + "570task3_target_enz_5_150_covcvgelu0123k50batch1weightv1_1t_0123_0.001_gat", 'all', "META", cv_all_result)
    save_result(str(idx) + "570task3_target_enz_5_150_covcvgelu0123k50batch1weightv1_1t_0123_0.001_gat", 'each', "META", cv_each_result)
...
save_result("570task3_target_enz_5_150_covcvgelu0123k50batch1weightv1_1t_0123_0.001_gat", 'all', "META", all_result)
save_result("570task3_target_enz_5_150_covcvgelu0123k50batch1weightv1_1t_0123_0.001_gat", 'each', "META", each_result)
