...
# for idx in [1]:
    ...
    for f in feature_sel:  
        ...
        if f == 3:
            feat_mtrx_sel = (np.load("smilenew570.npy") + np.load("targetnew570.npy") + np.load("enzymenew570.npy")) / 3.0
        epochs = 250
        best_acc = -1
        count = 0
        best_loss = 1000000.
        for epoch in range(epochs):
            ...
            if(acc > best_acc):
                ...
                torch.save(maml.state_dict(), "./ckpt/"+"570covgelucv0123k50adambatch1-"+str(idx)+"featurefusion-"+str(f)+"best.pt") 
                count = 0
            else:
                count+=1
            if count > 100:
                break
            print_file("570covgelucv0123k50adambatch1 epoch: {}, acc:{}, loss: {}".format(epoch, acc, l), "./result.out")
    ...
    print(cv_all_result)
    save_result(str(idx) + "570target_enz_5_150_768covgelu0123k50adambatch1_1t_0123_0.001_gat", 'all', "META", cv_all_result)
    save_result(str(idx) + "570target_enz_5_150_768covgelu0123k50adambatch1_1t_0123_0.001_gat", 'each', "META", cv_each_result)
...
save_result("570target_enz_5_150_768covgelu0123k50adambatch1_1t_0123_0.001_gat", 'all', "META", all_result)
save_result("570target_enz_5_150_768covgelu0123k50adambatch1_1t_0123_0.001_gat", 'each', "META", each_result)
