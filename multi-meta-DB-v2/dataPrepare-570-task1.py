...
def rename_ddi(df_drug, mechanism,action,drugA,drugB):
    name_dict = {}
    label_dict = {}
    count={}
    d_event=[]
...
def Data_triplets(idx):  
    ...
    index_all_class = np.load("570index_all_class_task1.npy", allow_pickle = True)
...
class GCN_Net(nn.Module):
    def __init__(self, num_inputs = 570, hidden_1 = 256, hidden_2 = 128, class_num = 47, n_heads = 2):  #n_heads = 1
    ...
    for f in feature_sel: 
        ...
        for epoch in range(epochs):
            ...
            if epoch % 5 ==0:
                ...
                print_file("570task1 epoch: {}, acc:{}, best_acc: {}".format(epoch, acc, best_acc), "./result.out")
...
save_result("570task1target_enz_5_150_enz_traget_4012smile_withdecay_bs512_epoch200", 'all', "META", all_result)
save_result("570task1target_enz_5_150_enz_traget_4012smile_withdecay_bs512_epoch200", 'each', "META", each_result)
