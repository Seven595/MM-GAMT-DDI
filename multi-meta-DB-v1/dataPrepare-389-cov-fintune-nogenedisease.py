...
for idx in [0, 1, 2, 3, 4]:
    ...
    save_result(str(idx) + "task2389covcv0123nogenedisk50withpathwayadambatch1new", 'all', "META", cv_all_result)
    save_result(str(idx) + "task2389covcv0123nogenedisk50withpathwayadambatch1new", 'each', "META", cv_each_result)
...
save_result("task2389covcv0123nogenedisk50withpathwayadambatch1new", 'all', "META", all_result)
save_result("task2389covcv0123nogenedisk50withpathwayadambatch1new", 'each', "META", each_result)
