...
def Data_triplets(idx):  
    ...
    index_all_class = np.load("389index_all_class_task1.npy", allow_pickle = True)
...
save_result("task1gelu_012345_withdecay_bs512_epoch200", 'all', "META", all_result)
save_result("task1gelu_012345_withdecay_bs512_epoch200", 'each', "META", each_result)
