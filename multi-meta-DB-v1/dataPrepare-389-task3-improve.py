...
for idx in range(5):
    ...
    for f in feature_sel:  
        maml.load_state_dict(torch.load("./ckpt/"+"389covcv0123k50adambatch1-"+str(idx)+"featurefusion-"+str(f)+"best.pt"))
        if f == 0:
    ...
    if len(pred_score_feature_best) == 6:
        pred_score_res = ((pred_score_feature_best[0] + pred_score_feature_best[1] + pred_score_feature_best[2] + pred_score_feature_best[3]+ pred_score_feature_best[4]+ pred_score_feature_best[5]) / 5).cpu().numpy()
    ...
    print(cv_all_result)
    save_result(str(idx) + "389task3_focal_target_enz_5_150_covcv0123k50batch1weightv1_1t_0123_0.001_gat", 'all', "META", cv_all_result)
    save_result(str(idx) + "389task3_focal_target_enz_5_150_covcv0123k50batch1weightv1_1t_0123_0.001_gat", 'each', "META", cv_each_result)
...
save_result("389task3_focal_target_enz_5_150_covcv0123k50batch1weightv1_1t_0123_0.001_gat", 'all', "META", all_result)
save_result("389task3_focal_target_enz_5_150_covcv0123k50batch1weightv1_1t_0123_0.001_gat", 'each', "META", each_result)
